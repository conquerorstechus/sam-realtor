  ...
  return (
    <section className="border-y border-black/8 bg-surface">
      <Container className="grid gap-4 py-8 sm:grid-cols-2 lg:grid-cols-4">
        {items.map((it) => (
          <div key={it.k} className="rounded-2xl border border-black/8 bg-surface-2 p-5 shadow-[var(--shadow-soft)]">
            <div className="text-2xl font-extrabold tracking-tight text-accent">{it.k}</div>
