...
const cards = [
  {
    title: "Buyers who refuse to lose",
    body: "Offer strategy, escalation clarity, inspection leverage, and a team that can move as fast as the market.",
    tag: "Multiple offers",
  },
  {
    title: "Sellers who want max leverage",
    body: "Pricing discipline + launch marketing + negotiation that protects your net - not just the headline price.",
    tag: "Listings",
  },
  {
    title: "Investors who think in spreadsheets",
    body: "Rent comps, rehab sensitivity, and exit scenarios - so you buy with a plan, not a hope.",
    tag: "ROI focus",
  },
  {
    title: "Military moves without chaos",
    body: "PCS timelines, VA fluency, and relocation workflows that respect real-world pressure.",
    tag: "MRP mindset",
  },
] as const;
